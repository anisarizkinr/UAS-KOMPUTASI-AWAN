        ...
        <div class="row">
            <div class="col-12 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up">
                <div class="icon-box">
                    ...
                    <p class="description">
                        Pada tahun 1995 terwujudlah Panti Asuhan Putri ‘Aisyiyah yang beralamat di jalan Mayjen Haryono gang 3 no. 231a Kelurahan Dinoyo Kecamatan Lowokwaru  Kota Malang yang pada 7 Juli 1996 diresmikan pemakaiannya oleh bapak H. Soesamto selaku Walikota Malang, dan mendapatkan akta notaris dengan nama Notaris CH. Weltre dengan nomor notaris 467/STP/ORSOS/III/97. Panti Asuhan Putri ‘Aisyiyah sudah melakukan pembaharuan akte notaris atau surat tanda pendaftaran ulang secara berkala, dan yang terbaru adalah sebagai berikut 46/07.05/02/IX/2021.  
                    </p><br>
                    <p class="description">
